    ...
    <>
      ...
      <div className="bg-gradient-to-b from-pink-50 to-pink-100 min-h-screen">
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-700 text-xl max-w-2xl mx-auto leading-relaxed">
              ...
              carefully curated products that speak to your style and
              personality.
            </p>
          </div>
        </section>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <h3 className="text-3xl font-bold mb-8 text-pink-900 text-center">
            ...
            {categories.map((category, index) => (
              ...
              >
                ...
                <div className="p-5 text-center">
                  <h4 className="text-2xl font-bold text-pink-800 mb-2">
                    {category.name}
                  </h4>
              ...
              {filteredProducts.slice(0, loadMore).map((product) => (
                <motion.div
                  ...
                  className={`bg-white shadow-lg rounded-xl overflow-hidden relative 
                    ${
                      viewMode === "list"
                        ? "flex items-center p-4 space-x-6"
                        : ""
                    }`}
                  variants={{
                ...
                >
                  ...
                  <div
                    className={`relative ${
                      viewMode === "grid" ? "aspect-video" : "w-1/4"
                    } bg-gray-100`}
                  >
                    <img
                      src={product.img}
                    ...
                    <div className="absolute top-2 right-2">
                      <span className="bg-pink-500 text-white text-xs px-2 py-1 rounded">
                        Save{" "}
                        {Math.round(
                          ((400 - product.price.split("₹")[2]
                            ? product.price.split("₹")[2]
                            : product.price) /
                            400) *
                            100
                        )}
                  ...
                  >
                    <div>
                      <h4
                        className={`font-semibold ${
                          viewMode === "grid" ? "text-sm" : "text-lg mb-2"
                        }`}
                      >
                        {product.name}
                      </h4>
                      ...
                      {viewMode === "list" && (
                        <p className="text-gray-600 mb-3 text-sm">
                          Discover our premium {product.category.toLowerCase()}{" "}
                          collection, carefully curated to bring joy and
                          inspiration.
                        </p>
                      )}
                    ...
                    >
                      <button
                        ...
                        onClick={(e) => {
                          addPostToRecentlyViewed(product._id);
                        }}
                      >
                        View Details
                      </button>
